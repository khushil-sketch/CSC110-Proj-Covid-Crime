...
def canada_covid_crime_line() -> None:
    """Run the code necessary to graph the line graph with PoliceData and CovidData"""
...
graph_button_1 = tk.Button(root, text="Covid Cases & Crime Rate against Time", command=canada_covid_crime_line, padx=10,
                           pady=10, bg="#47aeed", fg="white", font=button_font)
graph_button_1.grid(row=1, column=4, sticky="WE")


def physical_crime_scatter() -> None:
    """Run the code necessary to graph the physical crime vs covid cases scatter plot"""
    cases_20_21 = df.covid_data_canada_20_21_df['Number of New Active Cases in Canada']
    ...
    physical_covid_canada_20_21_axes.scatter(cases_20_21, physical_crimes_20_21.iloc[0:20], label='Data')
    ...
    physical_covid_canada_20_21_axes.plot(x_lin_reg, y_lin_reg, c='r', label='Regression')

    physical_r = round(np.corrcoef(cases_20_21, physical_crimes_20_21.iloc[0:20])[0, 1], 7)

    # Formatting the graph
    physical_covid_canada_20_21_axes.set_title("Relationship between Covid Cases & Physical Crime Cases (r="
                                               + str(physical_r) + ')')
...
graph_button_2 = tk.Button(root, text="Covid Cases vs Physical Crime Cases", command=physical_crime_scatter, padx=10,
                           pady=10, bg="#cf7ce6", fg="white", font=button_font)
graph_button_2.grid(row=3, column=4, sticky="WE")


def non_physical_crime_scatter() -> None:
    """Run the code necessary to plot the nonphysical crime vs covid cases scatter plot"""
    cases_20_21 = df.covid_data_canada_20_21_df['Number of New Active Cases in Canada']
    # Graph
    ...
    non_physical_covid_canada_20_21_axes.scatter(cases_20_21, non_physical_crimes_20_21.iloc[0:20], label='Data')
    ...
    non_physical_covid_canada_20_21_axes.plot(x_lin_reg, y_lin_reg, c='r', label='Regression')

    non_physical_r = round(np.corrcoef(cases_20_21, non_physical_crimes_20_21.iloc[0:20])[0, 1], 7)

    # Formatting the graph
    non_physical_covid_canada_20_21_axes.set_title("Relationship between Covid Cases & Non Physical Crime Cases (r="
                                                   + str(non_physical_r) + ')')
...
def public_crime_scatter() -> None:
    """Run the code necessary for public crime vs covid cases scatter plot"""
    cases_20_21 = df.covid_data_canada_20_21_df['Number of New Active Cases in Canada']
    # Graph
    ...
    public_covid_canada_20_21_axes.scatter(cases_20_21, public_crimes_20_21.iloc[0:20], label='Data')
    ...
    public_covid_canada_20_21_axes.plot(x_lin_reg, y_lin_reg, c='r', label='Regression')

    public_r = round(np.corrcoef(cases_20_21, public_crimes_20_21.iloc[0:20])[0, 1], 7)

    # Formatting the graph
    public_covid_canada_20_21_axes.set_title("Relationship between Covid Cases & Public Crime Cases (r="
                                             + str(public_r) + ')')
...
def private_crime_scatter() -> None:
    """Run the code necessary for private crime vs covid cases scatter plot"""
    cases_20_21 = df.covid_data_canada_20_21_df['Number of New Active Cases in Canada']
    # Graph
    ...
    private_covid_canada_20_21_axes.scatter(cases_20_21, private_crimes_20_21.iloc[0:20], label='Data')
    ...
    private_covid_canada_20_21_axes.plot(x_lin_reg, y_lin_reg, c='r', label='Regression')
    ...
    # Formatting the graph
    private_covid_canada_20_21_axes.set_title("Relationship between Covid Cases & Private Crime Cases (r="
                                              + str(private_r) + ')')
